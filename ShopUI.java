...
class ActionRemoveItem implements ActionListener {
    ...
    public ActionRemoveItem(ShopUI ui, Inventory inventory, ShopItem item) {
        this.shopUI = ui;
...
public class ShopUI extends JFrame {
    ...
    public ShopUI(int width, int height, String name) {
        ...
        inventory.addItem(goldenCarrot);
        inventory.addItem(steak);
        inventory.addItem(rottenFlesh);
